    ...
    <div className="flex flex-col gap-4 items-center justify-center min-h-screen">
      <div className="flex flex-col items-center gap-4 border p-8 rounded">
        ...
        <button
          ...
          className={`bg-transparent border border-white hover:bg-neutral-800 duration-300 text-white px-2 py-1 rounded ${
            buttonDisabled ? "opacity-30 cursor-not-allowed" : "cursor-pointer"
          }`}
        >
